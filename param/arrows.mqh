...
extern color   TradeArrowColorLongMod = CLR_NONE;
extern color   TradeArrowColorShortMod = CLR_NONE;
extern color   TradeArrowColorLongExit = CLR_NONE;
extern color   TradeArrowColorShortExit = CLR_NONE;